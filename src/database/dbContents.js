export const homeContent = {
  metaTitle: 'DronExperts | Vuelos, Fotografía Aérea y Más',
  ...
  section1: {
    ...
    p2: 'En nuestro sitio, encontrarás recursos y guías completas que te ayudarán a dar tus primeros pasos en el mundo de los drones. Aprenderás los conceptos básicos del vuelo, las mejores prácticas de seguridad y las regulaciones necesarias para volar de forma responsable. Además, te proporcionaremos consejos prácticos y trucos de pilotos experimentados para que puedas perfeccionar tus habilidades y disfrutar de vuelos emocionantes.',
    p3: '',
    linkWords: []
  },
  section2: {
    title: 'Captura imágenes impresionantes con la fotografía aérea',
    p1: 'La fotografía aérea es una forma fascinante de capturar el mundo desde una perspectiva completamente nueva. Con nuestros drones y cámaras aéreas de última generación, podrás elevar tu creatividad y capturar imágenes y vídeos impresionantes que dejarán a todos sin aliento.',
    p2: 'Nuestro sitio te brinda las herramientas y los conocimientos necesarios para convertirte en un experto en fotografía aérea. Aprenderás sobre los diferentes estilos y técnicas de captura, cómo ajustar la configuración de la cámara para obtener los mejores resultados y cómo editar y mejorar tus fotos para lograr resultados profesionales. Ya sea que desees capturar paisajes impresionantes, eventos deportivos emocionantes o imágenes únicas de viajes, te ayudaremos a llevar tus habilidades de fotografía aérea al siguiente nivel.',
    p3: '',
    linkWords: []
  },
  section3: {
    title: 'Drones profesionales y para principiantes',
    p1: 'En nuestro sitio web, encontrarás una amplia selección de drones profesionales y para principiantes que se adaptan a tus necesidades y preferencias. Si eres un piloto experimentado que busca un dron de alto rendimiento con funciones avanzadas, tenemos los últimos modelos con tecnología de vuelo autónomo, seguimiento de objetos y estabilización de imagen para garantizar resultados excepcionales.',
    p2: 'Para aquellos que se están adentrando en el mundo de los drones, ofrecemos una variedad de opciones amigables para principiantes. Estos drones son fáciles de manejar, cuentan con características de seguridad mejoradas y te brindan la oportunidad de aprender y perfeccionar tus habilidades de vuelo de manera segura y divertida.',
    p3: 'Nuestros expertos han realizado reseñas detalladas y comparativas de drones para que puedas tomar decisiones informadas al realizar tu compra. Entendemos que cada piloto tiene necesidades y objetivos diferentes, por lo que estamos aquí para ayudarte a encontrar el dron perfecto que se ajuste a tu presupuesto y expectativas.',
    linkWords: []
  },
  section4: {
    title: 'Accesorios esenciales y guías de vuelo',
    p1: 'Además de los drones, también ofrecemos una amplia gama de accesorios esenciales que te ayudarán a mejorar tu experiencia de vuelo. Desde baterías adicionales y hélices de repuesto hasta estuches de transporte y filtros para la cámara, tenemos todo lo que necesitas para garantizar vuelos sin problemas y capturas increíbles.',
    p2: 'Nuestras guías de vuelo te brindarán consejos prácticos, técnicas avanzadas y consideraciones de seguridad para que puedas aprovechar al máximo tus sesiones de vuelo. Aprenderás cómo planificar rutas de vuelo, evitar obstáculos y optimizar los ajustes del dron para obtener resultados óptimos. Ya seas un aficionado que busca explorar nuevos horizontes o un profesional en busca de mejorar tus habilidades, nuestras guías de vuelo te brindarán la información necesaria para que cada vuelo sea exitoso.',
    p3: '',
    linkWords: []
  },
  section5: {
    title: 'Únete a la revolución de los drones',
...
export const generalReviewsContent = {
  ...
  section2: {
    ...
    p2: '',
    p3: '',
    linkWords: [ 'Parrot', 'Parrot Anafi', 'Parrot Bebop 2 Power' ]
  },
  section3: {
    ...
    p2: '',
    p3: '',
    linkWords: [ 'Autel Robotics', 'Autel EVO II', 'Autel X-Star Premium' ]
  },
  section4: {
    title: 'Yuneec',
    ...
    p2: '',
    p3: '',
    linkWords: [ 'Yuneec', 'Yuneec Typhoon H Pro', 'Yuneec Mantis Q' ]
  },
  section5: {
    title: 'Holy Stone',
