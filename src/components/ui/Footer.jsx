      ...
      <div className="container">
        <div className="row">
          <div className="col-lg-12">
            ...
            <p>Para más información sobre las condiciones de compra en Amazon, te recomendamos revisar los <a href="https://www.amazon.com/gp/help/customer/display.html/?nodeId=508088" target='_blank' className='inter-link'>términos y condiciones</a> de Amazon.</p>
          </div>
        </div>
        <div className="row">
